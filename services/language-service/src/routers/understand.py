...
Required fields:
- intent: string (snake_case, e.g. "book_appointment", "capture_lead", "check_order_status", "get_business_info", "speak_to_human", "general_query")
- entities: array of {type, value, raw} objects
- sentiment: "positive" | "negative" | "neutral"
- language: "hi" | "en" | "hinglish"
- confidence: float 0.0–1.0

Use these exact intent names when possible:
  book_appointment, capture_lead, check_order_status, get_business_info, speak_to_human, cancel_appointment, payment_query, general_query

Example output:
{
  "intent": "book_appointment",
  "entities": [
    {"type": "name", "value": "Rahul", "raw": "mera naam Rahul hai"},
    {"type": "date", "value": "tomorrow", "raw": "kal ke liye"}
  ],
  "sentiment": "neutral",
  "language": "hinglish",
  "confidence": 0.92
